...
class BilledList extends StatefulWidget {
  const BilledList({super.key, required this.logedUser});
  final logedUser;
  @override
  State<BilledList> createState() => _BilledListState();
}

class _BilledListState extends State<BilledList> {
  @override
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: DatabaseHelper.instance
            .getSortedList(widget.logedUser[DatabaseHelper.columnId], 'Billed'),
